...
public class Fragment2 extends Fragment implements View.OnClickListener {
    ...
    private void initView() {
        mMapView = (MapView) view.findViewById(R.id.bMapView);
        relativeLayout =(RelativeLayout) view.findViewById(R.id.rlAddBill);
        relativeLayout.setOnClickListener(new RelListen());
        miniFab02Text =(TextView) view.findViewById(R.id.miniFab02Text);
        miniFabHertText =(TextView) view.findViewById(R.id.miniFabHertText);
        ...
        cbDelay  = (CheckBox) view.findViewById(R.id.cbDelay);
    ...
    private void setDefaultValues(){
        ...
        addBillTranslate3 = (AnimatorSet) AnimatorInflater.loadAnimator(getActivity(),R.animator.add_bill_anim);
        addBillTranslate4 = (AnimatorSet) AnimatorInflater.loadAnimator(getActivity(),R.animator.add_bill_anim);
        addBillTranslate5 = (AnimatorSet) AnimatorInflater.loadAnimator(getActivity(),R.animator.add_bill_anim);
        addBillTranslate6 = (AnimatorSet) AnimatorInflater.loadAnimator(getActivity(),R.animator.add_bill_anim);
    }
